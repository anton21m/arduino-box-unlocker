...
# changlog релизов
- 04.02.2026 (1.3) добавлены для индикации 2 светодиода с резистором 200 ОМ и их blink для отображения статуса вставки правильной карточки и решения головоломки. внедрен совет от alexgyver по сбросу состояния датчиков каждую 1-2 секунды
